...
Monte Carlo Methoden und Temporal Difference Learning betrachten jeweils nur einen Pfad und benötigen kein Modell. \todo{Check: Kein Modell oder ein kleineres ? Wir erstellen doch beim TD eigentlich auch ein Modell, wie ist hier die Abgrenzung ? OS}\\
...
\item[$+$] Robuster als DP gegenüber Verletzungen der Markov-Eigenschaft. Dies liegt daran, dass kein Bootstrapping stattfindet
...
\item[$-$] Ausreichende Exploration ist bei deterministischen Strategien ein Problem, da keine Alternativen Aktionen getestet werden. Dies kann z.B. mit zufälligen Zustands-Aktions-Paaren (sog. \emph{Exploring Starts}) verhindert werden
\end{description}
