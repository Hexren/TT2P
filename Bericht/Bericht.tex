...
\section{Temporal-Difference Learning}
	...
	Dynamic Programming \ref{sec:dynamicPrograming} und Monte Carlo Methoden \ref{sec:monteCarloMethoden} weisen Einschränkungen auf die im praktischen Einsatz die Größe der lösbaren Probleme stark einschränken. Dies sind im einzelnen:
	\begin{description}
